    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">SUSHI<span className="text-red-600">КАТ</span></h3>
            <p className="text-gray-400 mb-4">
              Доставка традиционных японских блюд, приготовленных 
              с соблюдением всех классических рецептов.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@sushikat.ru" className="hover:text-red-400 transition-colors duration-300">
                  info@sushikat.ru
                </a>
              </li>
              <li className="flex items-start">
                ...
                <div>
                  <p className="text-white">г. Москва, ул. Суши, д. 42</p>
                  <p className="text-gray-400 text-sm">10:00 - 23:00, без выходных</p>
                </div>
              </li>
            </ul>
          </div>
