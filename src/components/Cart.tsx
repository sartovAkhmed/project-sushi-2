      ...
      <div className="bg-white w-full max-w-md h-full flex flex-col shadow-xl">
        ...
        {orderSuccess ? (
          <div className="flex-1 p-6 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-2">Заказ оформлен!</h3>
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Корзина пуста</h3>
            <p className="text-gray-600 mb-6">
            ...
            {cartItems.map((cartItem) => (
              ...
              >
                ...
                <div className="ml-3 flex-1">
                  ...
                  <div className="text-sm text-gray-500">{cartItem.item.weight} г</div>
        ...
        {!isOrdering && !orderSuccess && cartItems.length > 0 && (
          <div className="p-4 border-t mt-auto">
            <div className="flex justify-between items-center mb-4">
              <div className="text-sm text-gray-600">Всего товаров: {cartItems.reduce((acc, item) => acc + item.quantity, 0)}</div>
              <button 
